...
/*
$pdf->write1DBarcode('0003', 'C128', '', '', '', 18, 0.4, $style, 'N');
$pdf->write1DBarcode('0003', 'C128', '', '', '', 18, 0.4, $style, 'N');
$pdf->write1DBarcode('0004', 'C128', '', '', '', 18, 0.4, $style, 'N');
$pdf->write1DBarcode('0004', 'C128', '', '', '', 18, 0.4, $style, 'N');
$pdf->write1DBarcode('0005', 'C128', '', '', '', 18, 0.4, $style, 'N');
$pdf->write1DBarcode('0005', 'C128', '', '', '', 18, 0.4, $style, 'N');
$pdf->write1DBarcode('0008', 'C128', '', '', '', 18, 0.4, $style, 'N');
$pdf->write1DBarcode('0008', 'C128', '', '', '', 18, 0.4, $style, 'N');
$pdf->write1DBarcode('0010', 'C128', '', '', '', 18, 0.4, $style, 'N');
$pdf->write1DBarcode('0010', 'C128', '', '', '', 18, 0.4, $style, 'N');
*/
